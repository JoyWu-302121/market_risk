...
Completed milestone notebooks can also be opened directly:

- [M02 public-data ingestion](https://colab.research.google.com/github/JoyWu-302121/market_risk/blob/main/notebooks/01_public_data_ingestion.ipynb)
